...
const PromptReply = forwardRef(
  ({ uuid, reply, pending, error, sources = [] }, ref) => {
    ...
    if (pending) {
      return (
        <div className="allm-py-[5px]">
          <div className="allm-flex allm-items-start allm-w-full allm-h-fit allm-justify-start allm-pl-[110px]">
            <img
              src={embedderSettings.settings.assistantIcon || AnythingLLMIcon}
              alt="Outamation AI Icon"
              className="allm-w-9 allm-h-9 allm-flex-shrink-0"
            />
            <div
              style={{
    ...
    return (
      // <div className="allm-py-[5px]">
      //   <div
      //     className="allm-text-[10px] allm-text-gray-400 allm-ml-[54px] allm-mr-6 allm-mb-2 allm-text-left allm-font-sans allm-pl-[110px]"
      //   >
      ...
      //     key={uuid}
      //     ref={ref}
      //     className="allm-flex allm-items-start allm-w-full allm-h-fit allm-justify-start allm-pl-[110px]"
      //   >
      //     <img
      //       src={embedderSettings.settings.assistantIcon || AnythingLLMIcon}
      //       alt="Outamation AI Icon"
      ...
      //       } allm-shadow-[0_4px_14px_rgba(0,0,0,0.25)] markdowned`}
      //     >
      //       <div className="allm-flex allm-gap-x-5 allm-rounded-xl">
      //         <span
      ...
      //   </div>
      //   <div
      //     className="allm-text-[10px] allm-text-gray-400 allm-ml-[54px] allm-mr-6 allm-mt-2 allm-text-left allm-font-sans allm-pl-[110px]"
      //   >
      //     {formatDate(Date.now() / 1000)}
      //   </div>
      // </div>
      <div
        className={`allm-font-sans allm-reply allm-whitespace-pre-line
        allm-font-normal allm-text-sm allm-md:text-sm allm-flex allm-flex-col
        allm-gap-y-1`}
      >
        <div className={`allm-flex allm-items-start allm-w-full allm-h-fit allm-justify-start allm-pl-[110px]`}>
          <img
